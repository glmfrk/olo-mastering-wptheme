...
?>
	<p>
		...
		<span class="notice-shortcode">
			...
			<b><?php echo esc_html("<?php cot_showheaderlogo(); ?>"); ?></b>
		</span>
	</p>
	...
	<img id="cot_customtheme_admin_preview" alt="header-logo" src="<?php echo esc_url( $cot_headerlogo ); ?>" /></span>
	<?php }
}
...
?>
	<p>
		...
		<span class="notice-shortcode"><?php esc_html_e('Use this shortcode for favicon icon','cot'); ?> <b><?php echo esc_html("<?php cot_showfaviconicon(); ?>"); ?></b></span>
	</p>
	<p class="description"><?php esc_html_e('Enter an image URL or use an image from media library.', 'cot' ); ?></p> 
	<?php if(empty($cot_faviconicon)) { 
		} else { ?>
	<img id="cot_favicon_admin_preview" alt="favicon-icon" src="<?php echo esc_url( $cot_faviconicon ); ?>" /></span>
	<?php }
}
...
function cot_globalheadercode() {
	...
	<textarea class="text-box" cols="10" rows="8" placeholder="Google analytical Code" name="cot_options[header_global_code]" ><?php echo esc_html($cot_headerglobalcode); ?></textarea>
...
function cot_otherheadercode() {
	...
	<textarea class="text-box" cols="10" rows="8" name="cot_options[header_code]" ><?php echo esc_html($cot_headerothercode); ?></textarea>
...
?>
	<p>
		...
		<?php echo '<span class="notice-shortcode">Use this shortcode for footer logo <b>'. esc_html("<?php cot_showfooterlogo(); ?>") . '</b> .</span>';  ?>
	</p>
	<p class="description"><?php esc_html_e('Enter an image URL or use an image from media library.', 'cot'); ?></p> 
	<?php if(empty($cot_footerlogo)) { 
		} else { ?>
	<img id="cot_customtheme_footer_admin_preview" alt="footer-logo" src="<?php echo esc_url( $cot_footerlogo ); ?>" /></span>
	<?php }
...
?>
	...
	<span class="notice-shortcode"><?php esc_html_e( 'Use this shortcode for copy right text', 'cot' ); ?><b> <?php echo esc_html("<?php cot_copyright(); ?>"); ?></b> </span></p>
<?php
}
...
<p>
	...
	<span class="notice-shortcode"><?php esc_html_e( 'Use this shortcode for design & development text.', 'cot' ); ?><b><?php echo esc_html("<?php cot_designdevelopent(); ?>"); ?></b></span>
</p>
<?php
}
...
function cot_otherfootercode(){
	...
	<textarea class="text-box" cols="10" rows="8" name="cot_options[footer_code]" ><?php echo esc_html($cot_footerglobalcode); ?></textarea>
...
?>
	<p>
		...
		<span class="notice-shortcode"><?php esc_html_e('Use this shortcode for Facebook link' ,'cot'); ?> <b><?php echo esc_html("<?php cot_facebook(); ?>"); ?></b></span>
	</p>
<?php }
...
?>
	<p>
		...
		<span class="notice-shortcode"><?php esc_html_e('Use this shortcode for Twitter link' , 'cot'); ?> <b><?php echo esc_html("<?php cot_twitter(); ?>"); ?></b></span>
	</p>
<?php }
...
?>
	<p>
		...
		<span class="notice-shortcode"><?php esc_html_e('Use this shortcode for Linkedin link','cot' );?> <b><?php echo esc_html("<?php cot_linkedin(); ?>"); ?></b></span>
	</p>
<?php }
...
?>
	<p>
		...
		<span class="notice-shortcode"><?php esc_html_e('Use this shortcode for Instagram link', 'cot'); ?> <b><?php echo esc_html("<?php cot_instagram(); ?>"); ?></b></span>
	</p>
<?php }
...
?>
	<p>
		...
		<span class="notice-shortcode"><?php esc_html_e('Use this shortcode for Google + link','cot'); ?> <b><?php echo esc_html("<?php cot_googleplus(); ?>"); ?></b>
	</p>
<?php }
...
?>
	<p>
		...
		<span class="notice-shortcode"><?php esc_html_e('Use this shortcode for Custom Option link','cot' ); ?> <b><?php echo esc_html("<?php cot_customoption1(); ?>"); ?></b>
	</p>
<?php }
...
?>
	<p>
		...
		<span class="notice-shortcode"><?php esc_html_e('Use this shortcode for Custom Option link','cot'); ?> <b><?php echo esc_html("<?php cot_customoption2(); ?>"); ?></b>
	</p>
<?php }
...
function cot_showfooterlogo() {
	...
	?>
	<img src="<?php echo esc_url( $cot_footerimage ); ?>" alt="<?php bloginfo( 'name' ); ?>">
	<?php
}
...
$options = cot_getoptions();
	...
	<?php echo esc_html( $cot_headergcode ); ?><?php 
}
...
$options = cot_getoptions();
	...
	<?php echo esc_html( $cot_headerocode ); ?><?php 
}
...
$options = cot_getoptions();
	...
	<?php echo esc_html( $cot_footerocode ); ?><?php 
}
